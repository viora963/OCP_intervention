...
def technician_toggle_availability(request):
    ...
    tech.disponible = not tech.disponible
    tech.save(update_fields=['disponible'])
    log_activity(request.user, "Changement disponibilité", tech.disponible and "Disponible" or "Indisponible")

    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        return JsonResponse({'ok': True, 'disponible': tech.disponible})
